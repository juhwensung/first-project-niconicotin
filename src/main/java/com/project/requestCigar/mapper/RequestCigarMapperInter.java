...
public interface RequestCigarMapperInter {
	...
	@Update("update cigar_request set request_subject=#{request_subject}, request_content=#{request_content}, request_cigar_brand=#{request_cigar_brand}, "
			+ "request_cigar_name=#{request_cigar_name}, request_tar=#{request_tar}, request_nicotine=#{request_nicotine}, request_file_name=#{request_file_name}, request_file_size=#{request_file_size}, request_public=#{request_public} "
			+ "where request_seq=#{request_seq}")
	int requestModify_ok(RequestCigarTO to);
	
	@Update("update cigar_request set request_subject=#{request_subject}, request_content=#{request_content}, request_cigar_brand=#{request_cigar_brand}, "
			+ "request_cigar_name=#{request_cigar_name}, request_tar=#{request_tar}, request_nicotine=#{request_nicotine}, request_public=#{request_public} "
			+ "where request_seq=#{request_seq}")
